...
* [When to Use Context](broken-reference)
* [Before You Use Context](broken-reference)
* [API](broken-reference)
  * [React.createContext](broken-reference)
  * [Context.Provider](broken-reference)
  * [Class.contextType](broken-reference)
  * [Context.Consumer](broken-reference)
  * [Context.displayName](broken-reference)
* [Examples](broken-reference)
  * [Dynamic Context](broken-reference)
  * [Updating Context from a Nested Component](broken-reference)
  * [Consuming Multiple Contexts](broken-reference)
* [Caveats](broken-reference)
* [Legacy API](broken-reference)
...
All consumers that are descendants of a Provider will re-render whenever the Provider’s `value` prop changes. The propagation from Provider to its descendant consumers (including [`.contextType`](broken-reference) and `useContext`) is not subject to the `shouldComponentUpdate` method, so the consumer is updated even when an ancestor component skips an update.
...
> Note
>
> The way changes are determined can cause some issues when passing objects as `value`: see [Caveats](broken-reference).
...
The `contextType` property on a class can be assigned a Context object created by [`React.createContext()`](broken-reference). Using this property lets you consume the nearest current value of that Context type using `this.context`. You can reference this in any of the lifecycle methods including the render function.

> Note:
>
> You can only subscribe to a single context using this API. If you need to read more than one see [Consuming Multiple Contexts](broken-reference).
>
