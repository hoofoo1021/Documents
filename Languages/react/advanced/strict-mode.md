...
* [Identifying components with unsafe lifecycles](broken-reference)
* [Warning about legacy string ref API usage](broken-reference)
* [Warning about deprecated findDOMNode usage](broken-reference)
* [Detecting unexpected side effects](broken-reference)
* [Detecting legacy context API](broken-reference)
* [Ensuring reusable state](broken-reference)
